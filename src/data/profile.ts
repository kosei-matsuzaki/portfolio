...
export const profile = {
  ...
  /** ヒーロー下の紹介文（2〜3文） */
  intro:
    "最適化アルゴリズムの研究をしながら、機械学習・数値シミュレーション・3D ゲーム・モバイルアプリまで領域を絞らずに個人開発をしています。" +
    "ライブラリに任せきりにせず、探索アルゴリズムやニューラルネットの推論エンジンを自分で実装して、" +
    "うまくいったこともいかなかったことも定量的に検証して残すことを大事にしています。",
